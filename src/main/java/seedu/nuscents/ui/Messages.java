...
public class Messages {
    ...
    public static final String MESSAGE_UNKNOWN_EXPENSE_CATEGORY = "OOPS!!! The category you provided is not a valid category.\n"
            + "Valid categories are FOOD/ENTERTAINMENT/TRANSPORTATION/UTILITY/RENT/OTHERS.";
    public static final String MESSAGE_UNKNOWN_ALLOWANCE_CATEGORY = "OOPS!!! The category you provided is not a valid category.\n"
