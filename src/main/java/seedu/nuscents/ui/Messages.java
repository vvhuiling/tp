...
public class Messages {
    ...
    public static final String MESSAGE_FILE_ACCESS_ERROR = "OOPS!!! A problem occurred while accessing the data file. Ensure "
            + "you have the correct permissions.";
    public static final String MESSAGE_FILE_PARSE_ERROR = "OOPS!!! A problem occurred while accessing the data file. Ensure "
            + "you have the correct permissions.";
